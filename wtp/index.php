...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit'])) {
  ...
  $result = smtp_mailer($email, 'OTP', "<p>This is $random</p>");
...
<body>
  <h1 class="com">EcoSplash</h1>
    ...
    <form class="form" method="post" > <!-- Specify the method as "post" and action as "send_otp.php" -->
        <input placeholder="E-mail" id="email" name="email" type="email" class="input" required=""/>
        <input type="submit" value="Generate OTP" class="login-button" name="submit" /> <!-- Add name="submit" to the submit button -->
